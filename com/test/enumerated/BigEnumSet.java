...
public class BigEnumSet {
  ...
  // There are two implementations of EnumSet in JDK:
  // RegularEnumSet which can hold 64 elements and backed by one long.
  // JumboEnumSet which can hold more than 64 elements and backed by array of longs.
